...
TMRPath.prototype.contains = function (path) {
    var b = this._level, c = path._level;
    if (this.length() > path.length())return!1;
    for (; b < this._subpaths.length;) {
        if (this._subpaths[b] !== path._subpaths[c])return!1;
        ++b;
        ++c
    }
    return!0
