...
(function() {
    ...
    function z(a, b, c, d) {
        if ((!d || n(c)) && "function" != getTypeName(c)) throw Error(y(a, b, d) + "must be a valid function.");
    }

    function va(a, b, c) {
        if (n(c) && (!isObjectOrFunction(c) || null === c)) throw Error(y(a, b, !0) + "must be a valid context object.");
    };
    ...
    function Ba(a, b, c, d) {
        ...
        if ("function" == getTypeName(b)) throw Error(a + "contains a function" + Ca(d) + " with contents: " + b.toString());
    ...
    function Fa(a, b, c, d) {
        if (!(d && !n(c) || null === c || isNumber(c) || isString(c) || isObjectOrFunction(c) && A(c, ".sv"))) throw Error(y(a, b, d) + "must be a valid firebase priority (a string, number, or null).");
    }
    function Ga(a, b, c) {
        if (!c || n(b)) switch (b) {
        case "value":
    ...
    function FirebaseQuery(a, b, c, d, e, f, g) {
        this.m = a;
        this.path = b;
        this.Ca = c;
        this.da = d;
    ...
    /* fb */
    FirebaseQuery.prototype.on = function(a, b) {
    ...
    /* off */
    FirebaseQuery.prototype.zb = function(a, b, c) {
    ...
    /* once */
    FirebaseQuery.prototype.once = function(a, b) {
        function c(g) {
    ...
    /* Sd limit */
    FirebaseQuery.prototype.limit = function(a) {
        ...
        return new FirebaseQuery(this.m, this.path, a, this.da, this.wa, this.Aa, this.Ya)
    };
    
    /* Ad startAt */
    FirebaseQuery.prototype.startAt = function(a, b) {
        x("Query.startAt", 0, 2, arguments.length);
        Fa("Query.startAt", 1, a, !0);
        Ha("Query.startAt", b);
        n(a) || (b = a = null);
        return new FirebaseQuery(this.m, this.path, this.Ca, a, b, this.Aa, this.Ya)
    };
    
    /* gd endAt */
    FirebaseQuery.prototype.endAt = function(a, b) {
        x("Query.endAt", 0, 2, arguments.length);
        Fa("Query.endAt", 1, a, !0);
        Ha("Query.endAt", b);
        return new FirebaseQuery(this.m, this.path, this.Ca, this.da, this.wa, a, b)
    };
    
    /* Kd equalTo */
    FirebaseQuery.prototype.equalTo = function(a, b) {
    ...
    FirebaseQuery.prototype.Qa = function() {
        var a = La(Ka(this));
        return "{}" === a ? "default" : a
    };
    ...
    (function() {
        var a = "",
            b;
        if (Ib && aa.opera) return a = aa.opera.version, "function" == getTypeName(a) ? a() : a;
    ...
    function bc(a, b) {
        if (isArray(a)) for (var c = 0; c < a.length; ++c) b(c, a[c]);
        else cc(a, b)
    }
    function dc(a, b) {
        return b ? r(a, b) : a
    ...
    P.prototype.hasChild = function(a) {
    ...
    function uc(a) {
        v(isArray(a) && 0 < a.length, "Requires a non-empty array");
        this.Gd = a;
        this.xb = {}
    }
    ...
    var bd = [Qc, FirebaseSocket];

    function ad(a, b) {
        var c = FirebaseSocket && FirebaseSocket.isAvailable(),
    ...
    function FBServerTime(a) {
        a = S(a.Jc, new F(".info/serverTimeOffset")).V() || 0;
        return (new Date).getTime() + a
    }
    function Ge(a) {
        a = a = {
            timestamp: FBServerTime(a)
        };
    ...
    function E(a, b) {
        var c, d;
        if (a instanceof FirebaseIMP) c = a, d = b;
        else {
    ...
    E.prototype.child = function(a) {
        x("Firebase.child", 1, 1, arguments.length);
        if (isNumber(a)) a = String(a);
    ...
    E.prototype.setWithPriority = function(a, b, c) {
